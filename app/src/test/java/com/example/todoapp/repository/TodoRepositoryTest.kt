...
class TodoRepositoryTest {
    ...
    @Test
    fun toggleTodoCompleted_updatesCompletionStatus() = runBlocking {
        // Given
        val date = Date()
        ...
        // Then
        verify(todoDao).updateTodo(argThat {
            this.id == 1L && this.isCompleted && this.completedDate != null
        })
    }

    @Test
    fun toggleTodoCompleted_undoesCompletionStatus() = runBlocking {
        // Given
        val date = Date()
    ...
    @Test
    fun deleteAllCompletedTodos_callsDao() = runBlocking {
        // When
